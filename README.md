...
| Backend | Frontend | Mobile | Database | Tooling |
|---------|----------|--------|----------|---------|
| RPG FREE | React | React Native | SQL (DB2) | Rust |
| Java | Angular | TypeScript | IBM i DB2 | VSCode Extensions |
| Node.js | TypeScript | | PostgreSQL | Docker |
| Express | HTML/CSS | | | MCP Servers |
...
![VSCode](https://img.shields.io/badge/VSCode%20Extensions-007ACC?style=flat-square&logo=visualstudiocode&logoColor=white)
...
Full-stack applications from design to deployment. React and Angular on the frontend, Node.js and Java on the backend, TypeScript everywhere. I build responsive interfaces, REST APIs, real-time WebSocket systems, and mobile apps with React Native. Docker containers, CI/CD pipelines, cloud hosting — the full picture, not just the UI.
